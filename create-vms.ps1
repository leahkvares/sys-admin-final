...
Write-Host "Running test remote onto the windows 10 host"
...
Start-Sleep -Seconds 10 # Ensure it has time to run
Write-Host "Executing script generated by testing remote on windows 10 host" 
.\runcmd.ps1 -Target Client -Exec Cmd "C:\Users\Student\Desktop\script.ps1" # Test remote execution of local file
Start-Sleep -Seconds 10 # Ensure its had time to run
Write-Host "Complete"
